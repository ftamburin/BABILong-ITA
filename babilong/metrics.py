...
TASK_LABELS_ENG = {'qa1': ['bathroom', 'bedroom', 'garden', 'hallway', 'kitchen', 'office'], 
...
TASK_LABELS_ITA = {
 'qa1': ['bagno', 'camera', 'giardino', 'corridoio', 'cucina', 'ufficio'], 
 'qa2': ['bagno', 'camera', 'giardino', 'corridoio', 'cucina', 'ufficio'], 
 'qa3': ['bagno', 'camera', 'giardino', 'corridoio', 'cucina', 'ufficio'], 
 'qa4': ['bagno', 'camera', 'giardino', 'corridoio', 'cucina', 'ufficio'], 
 'qa5': ['Daniele', 'Enrico', 'Giovanni', 'Maria', 'mela', 'pallone', 'latte']
}
